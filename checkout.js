...
function mainScript($) {
    var showPixel = showImgPixel = showImgPixel2 = pinterest_id = '';
    pinterest_id = 2614349527611;
    ...
    showImgPixel = `<img height='1' width='1' style='display:none;' alt='' src='https://ct.pinterest.com/v3/?tid=${pinterest_id}&noscript=1' /> `;
    ...
    showImgPixel2 = `<img height='1' width='1' style='display:none;' alt='' src='https://ct.pinterest.com/v3/?tid=${pinterest_id}&event=checkout&noscript=1'/>`;

    var script2 = document.createElement("script");
    var noscript2 = document.createElement("noscript");
    script2.type = "text/javascript";
    script2.innerHTML = `pintrk('track', 'checkout',{value: ${total_price},currency: ${cur},order_quantity: ${line_itemsLen});`;
